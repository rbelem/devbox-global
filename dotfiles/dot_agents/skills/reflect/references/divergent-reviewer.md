...
- `Read` tool calls against any `SKILL.md` file (workspace `.opencode/skills/`, user-level `~/.config/opencode/skills/`, or plugin-installed paths under `~/.config/opencode/plugins/`)
